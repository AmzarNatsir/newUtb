...
<head>
  ...
  <title>UTB | Print Laporan Pembayaran Piutang</title>
...
<tr>
    <td style="text-align: left;">
        <h5>LAPORAN PEMBAYARAN PIUTANG</h5>
        <span class='badge bg-success' style='font-size: 8pt; text-align: left'>Periode : {{ $periode }}<br><br>Customer : {{ $customer }}</span>
    </td>
</tr>
</table>
<br>
