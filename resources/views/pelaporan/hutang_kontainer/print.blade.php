...
<head>
  ...
  <title>UTB | Print Laporan Pembayaran Hutang Kontainer</title>
...
<tr>
    <td style="text-align: left;">
        <h5>LAPORAN PEMBAYARAN HUTANG <br>KONTAINER</h5>
        <span class='badge bg-success' style='font-size: 8pt; text-align: left'>Periode : {{ $periode }}<br><br>Kontainer : {{ $kontainer }}</span>
    </td>
</tr>
</table>
<br>
