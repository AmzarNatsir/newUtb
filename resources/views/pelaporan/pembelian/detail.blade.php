    ...
    <table class="table-bordered table-vcenter table-responsive" style="font-size: 11pt; width: 100%;">
        <thead>
            <tr>
                ...
                <th colspan="5" class="text-center">Receive</th>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td style='text-align: right' colspan="2"><b>{{ number_format($head->total_receice, 0) }}</b></td>
            ...
            <tr>
                ...
                <td style='text-align: right' colspan="2"><b>{{ number_format($head->total_receive_net, 0) }}</b></td>
                <td colspan="2"></td>
            </tr>
            <tr>
                <td colspan='7' style='text-align: right'><b>NET</b></td>
                <td colspan="2"></td>
                <td style='text-align: right; color:green' colspan="2"><b>{{ number_format($head->total_receive_net - $total_return, 0) }}</b></td>
            </tr>
        </tbody>
    </table>
</div>
