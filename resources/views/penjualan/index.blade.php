...
<script>
    ...
    var hitDiskonNilai = function(el)
    {
        ...
        currentRow.find('td:eq(7) input[name="item_diskon[]"]').val(Math.floor(persen_disk_total));
        hitungSubTotal(el)
    }
