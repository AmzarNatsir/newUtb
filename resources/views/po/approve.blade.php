...
{{csrf_field()}}
    ...
    <div class="modal-footer justify-content-between">
        ...
        <button type="button" class="btn btn-outline-danger" id="tbl_print" onclick="goPrint(this)" value="{{ $resHead->id }}">Print PO</button>
        <button type="button" class="btn btn-outline-success" id="tbl_approve" disabled>Approve</button>
    </div>
</form>
