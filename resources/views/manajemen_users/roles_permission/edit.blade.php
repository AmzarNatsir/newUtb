                        ...
                        <tr>
                            ...
                            <table style="width: 100%; font-size: 10pt">
                                ...
                                <tr>
                                    ...
                                    <td style="width: 5%;"><div class="form-group clearfix">
                                            <div class="icheck-danger d-inline">
                                                <input type="checkbox" id="checkPelaporanReturnPS" name="checkMenu[43]" value="laporan_return_ps" {{ in_array('laporan_return_ps', $rolePermissions) ? 'checked' : '' }}>
                            ...
                            <td style="width: 50%; vertical-align: top;">
                                <table style="width: 100%; font-size: 10pt">
                                    ...
                                    <tr>
                                        ...
                                        <td style="width: 5%;"><div class="form-group clearfix">
                                                <div class="icheck-danger d-inline">
                                                    <input type="checkbox" id="checkDaftarTransPemberianSample" name="checkMenu[41]" value="daftar_transaksi_pemberian_sample" {{ in_array('daftar_transaksi_pemberian_sample', $rolePermissions) ? 'checked' : '' }}>
                                    ...
                                    <tr>
                                        ...
                                        <td style="width: 5%;"><div class="form-group clearfix">
                                                <div class="icheck-danger d-inline">
                                                    <input type="checkbox" id="checkTransReturnPemberianSample" name="checkMenu[42]" value="transaksi_return_pemberian_sample" {{ in_array('transaksi_return_pemberian_sample', $rolePermissions) ? 'checked' : '' }}>
