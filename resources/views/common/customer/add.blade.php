...
<form action="{{ route('customerStore') }}" method="post" onsubmit="return konfirm()">
{{csrf_field()}}
    <div class="modal-body">
        <div class="form-group">
            <label for="inp_kode">Kode</label>
            <input type="text" name="inp_kode" id="inp_kode" class="form-control" maxlength="20" value="{{ $kode_baru }}" readonly>
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
            ...
            <input type="text" name="inp_kota" id="inp_kota" class="form-control" maxlength="100" required>
        </div>
        <div class="form-group">
