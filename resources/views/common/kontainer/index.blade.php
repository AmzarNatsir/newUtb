...
<section class="content">
    ...
    <div class="card-header">
        <h3 class="card-title">Kontainer</h3>
    ...
    <div class="card-body">
        ...
        <table class="table table-bordered table-hover datatable ListData" style="width: 100%;">
            ...
            <tr>
                ...
                <th class="text-center">Kontainer</th>
            ...
            <tbody>
            @php $nom=1 @endphp
            @foreach($allKontainer as $list)
            <tr>
                <td class="text-center">{{ $nom }}</td>
                <td>{{ $list->nama_kontainer }}</td>
                <td>{{ $list->alamat }}</td>
                <td>{{ $list->email }}</td>
                ...
                <td>
                    ...
                    <div class="dropdown-menu">
                        ...
                        <a href="{{ url('kontainerDelete') }}/{{ $list->id }}" class="dropdown-item" onclick="return konfirmHapus()" ><i class="fa fa-trash-alt"></i> Delete</a>
                    </div>
                  </div>
                </td>
            </tr>
...
<script type="text/javascript" src="{{ asset('assets/js/common/kontainer.js') }}"></script>
@endsection
