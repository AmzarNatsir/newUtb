...
<form action="{{ route('kontainerUpdate', $res->id) }}" method="post">
{{ csrf_field() }}
{{ method_field('PUT') }}
    <div class="modal-body">
    <div class="form-group">
            <label for="inp_nama">Nama Kontainer</label>
            <input type="text" name="inp_nama" id="inp_nama" class="form-control" maxlength="200" value="{{ $res->nama_kontainer }}" required>
        </div>
        <div class="form-group">
