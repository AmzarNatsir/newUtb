...
@section('breadcrumb', 'Penerimaan Via')
@section('content')
@routes
<!-- content -->
<section class="content">
    ...
    <div class="card-header">
        <h3 class="card-title">Penerimaan Via</h3>
            ...
            <tr>
                ...
                <td>
                    ...
                    <div class="dropdown-menu">
                        ...
                        <a href="{{ url('viaDelete') }}/{{ $list->id }}" class="dropdown-item" onclick="return konfirmHapus()" ><i class="fa fa-trash-alt"></i> Delete</a>
                    </div>
                  </div>
                </td>
            </tr>
...
<!-- <script type="text/javascript" src="{{ asset('assets/js/common/via.js') }}"></script> -->
<script>
    $(function(){
        let APP_URL_ADD = route('viaAdd');
    ...
    var goEdit = function(el) {
        $("#frm_modal").load(route('viaEdit', $(el).val()));
    }
