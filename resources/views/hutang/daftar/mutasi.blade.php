...
<div class="modal-body">
    <div class="row">
        ...
        <thead>
            ...
            <tr>
                <th>Supplier</th>
                <th>: {{ $main->get_supplier->nama_supplier }}</th>
                <th>Jatuh Tempo</th>
        ...
        <table class="table table-striped">
            ...
            <tbody>
                <tr>
                    ...
                    <td style="text-align: right;"><b>{{ number_format($main->total_receive_net, 0) }}</b></td>
                    <td></td>
                </tr>
                @php
                    $nom=1;
                    $n_outs = $main->total_receive_net;
                @endphp
...
<script>
    ...
    {
        var id_data = $(el).val();
        window.open(route('pembayaranHutangMutasiPrint', id_data), "_blank");
    }
</script>
