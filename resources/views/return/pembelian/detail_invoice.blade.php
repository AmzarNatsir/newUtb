<form action="{{ route('returnPembelianStore') }}" method="post" onsubmit="return konfirm()">
{{csrf_field()}}
<input type="hidden" name="inpReceiveId" id="inpReceiveId" value="{{ $dtHead->id }}">
    ...
    <table class="table table-hover table-striped" style="font-size: 12px">
        <thead>
            ...
            <tr>
                ...
                <th class="text-center" style="width: 12%">Sub Total</th>
            </tr>
        </thead>
        <tbody>
        ...
        <tr>
            ...
            <td align="center"><input type="hidden" name="temp_qty[]" id="temp_qty[]" value="{{ $list->qty }}"><input type="text" min="1" max="1000" id="item_qty[]" name="item_qty[]" class="form-control form-control-sm angka" value="{{ $selisih_receive }}" style="text-align:center" readonly></td>
            ...
            <td class="text-right"><input type="text" name="item_sub_total[]" value="{{ $sub_total_receive }}" class="form-control form-control-sm text-right angka" readonly></td>
        ...
        <div class="card">
            <div class="card-body">
                <div class="form-group row">
                    ...
                    <div class="col-sm-6">
                        <input type="text" class="form-control input-sm" name="inpNoInvoice" id="inpNoInvoice" value="{{ $dtHead->nomor_receive }}" readonly>
                    </div>
                </div>
                <div class="form-group row">
                    <label for="inpTglInvoice" class="col-sm-6 col-form-label">Tgl. Invoice</label>
                    <div class="col-sm-6">
                        <input type="text" class="form-control input-sm" name="inpTglInvoice" id="inpTglInvoice" value="{{ date_format(date_create($dtHead->tanggal_receive), 'd-m-Y') }}" readonly>
                    </div>
                </div>
                <div class="form-group">
                    <label for="inpSupplier">Supplier</label>
                    <input type="text" class="form-control input-sm" name="inpSupplier" id="inpSupplier" value="{{ $dtHead->get_supplier->nama_supplier }}" readonly>
                </div>
                <div class="form-group row">
