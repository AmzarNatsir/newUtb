...
<section class="content">
    ...
    <div class="card-header">
        <h3 class="card-title">Return Pembelian</h3>
    </div>
...
<script>
    ...
    var goSearch = function()
    {
        ...
        $.ajax({
            ...
            type: "POST",
            url: route('returnPembelianSearch'),
            dataType: "json",
            data: {
                search: keyWord
            },
            ...
            success: function( data ) {
                ...
                if(data.success=='false')
                {
                    ...
                    if (result.isConfirmed) {
                        $("#viewInvoice").load("{{ url('returnPembelianDetailInvoice') }}/"+data.data.id);
                    } else if (
    ...
    var goFilter = function()
    {
        ...
        $(".viewList").load("{{ url('returnPembelianFilter') }}/"+supplier, function(){
            $('#spinner-div').hide();
        });
    }
    ...
    var viewInvoice = function(el)
    {
        ...
        $("#viewInvoice").load("{{ url('returnPembelianDetailInvoice') }}/"+id_invoice, function(){
            $('#spinner-div').hide();
        });
        $('.angka').number( true, 0 );
    }
