<div class="modal-header">
    <h4 class="modal-title">Approve Purchase Order Tingkatan Kedua</h4>
...
<div class="modal-body">
    ...
    <form action="{{ route('persetujuanPOStore_2') }}" method="post" onsubmit="return konfirm()">
    {{csrf_field()}}
            ...
            <div class="card card-success">
                ...
                <div class="card-body">
                    ...
                    <thead>
                        ...
                        <tr>
                            <td>Keterangan</td>
                            <td>: {{ $resHead->approved_note }}</td>
                        </tr>
                        <tr>
                            <td>Oleh</td>
                            <td>: {{ $resHead->get_approver_1->name }}</td>
                        </tr>
                    </thead>
                    </table>
                </div>
