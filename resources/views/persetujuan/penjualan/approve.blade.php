<div class="modal-header">
    <h4 class="modal-title">Approve Transaksi</h4>
    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
    <span aria-hidden="true">&times;</span></button>
</div>
<form action="{{ route('approvePOStore', $head->id) }}" method="post" onsubmit="return konfirm()">
{{csrf_field()}}
{{ method_field('PUT') }}
                ...
                <div class="card">
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label for="inp_kemasan">Tanggal Invoice</label>
                                    <input type="text" class="form-control" value="{{ date_format(date_create($head->tgl_invoice), 'd-m-Y') }}" readonly>
                                </div>
                            </div>
                        </div>
                        <div class="form-group">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            ...
                            $cat = 'Invoice Ditolak. Stok Tidak Mencukupi'
                            @endphp
                            @else
                            @php $enabled_cat = "";
                            $cat = '';
